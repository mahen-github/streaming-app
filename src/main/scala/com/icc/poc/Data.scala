...
case class Data(val customer_id: Long, acct_num: Long, customer_profile: String, trans_num: Long, trans_date: String, trans_time: String, unix_time: Long, category: String, amt: Double, is_fraud: Short) {
